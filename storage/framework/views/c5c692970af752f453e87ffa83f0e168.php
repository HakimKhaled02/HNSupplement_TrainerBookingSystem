...
<?php $__env->startSection('title', 'Book Trainer - ' . $trainer->user->name); ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="booking-trainer-card">
                    ...
                    <div class="booking-trainer-info">
                        <h2 class="booking-trainer-name"><?php echo e($trainer->user->name); ?></h2>
                        <div class="booking-trainer-rating">
                            <div class="booking-rating-stars">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="bi bi-star-fill <?php echo e($i <= floor($trainer->rating ?? 0) ? 'filled' : ''); ?>"></i>
                                <?php endfor; ?>
                            </div>
                            <span class="booking-rating-value"><?php echo e(number_format($trainer->rating ?? 0, 1)); ?></span>
                        </div>
            ...
            <div class="col-lg-8">
                <div class="booking-form-card">
                    ...
                    <form action="<?php echo e(route('booking.store')); ?>" method="POST" id="booking-form" class="booking-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="booking-form-section">
                            ...
                            <div class="booking-days-selection">
                                <?php if(!empty($availableDays)): ?>
                                    <?php $__currentLoopData = $availableDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayKey => $dayData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="booking-day-checkbox-label">
                                            <input type="checkbox" 
                                                   name="selected_days[]" 
                                                   value="<?php echo e($dayKey); ?>"
                                                   class="booking-day-checkbox"
                                                   data-day="<?php echo e($dayKey); ?>">
                                            <span class="booking-day-name"><?php echo e($dayData['name']); ?></span>
                                        </label>
                        ...
                        <div class="booking-form-actions">
                            <a href="<?php echo e(route('trainers')); ?>" class="booking-cancel-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const availableTimeSlots = <?php echo json_encode($availableDays, 15, 512) ?>;
    const trainerId = <?php echo e($trainer->id); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hnsupplement\resources\views/trainers/book.blade.php ENDPATH**/ ?>