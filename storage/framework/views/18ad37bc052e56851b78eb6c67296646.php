...
<body style="font-family: 'Poppins', Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px;">
        ...
        <div style="background-color: #1a1a1a; color: #ffffff; padding: 30px; border-radius: 10px; margin-bottom: 30px;">
            <p style="margin: 0 0 20px 0; font-size: 16px;">Hello <?php echo e($user->name); ?>,</p>
            ...
            <div style="background-color: rgba(0, 204, 102, 0.1); border: 1px solid #00cc66; border-radius: 8px; padding: 20px; margin: 20px 0;">
                ...
                <p style="margin: 5px 0; font-size: 14px;"><strong>Email:</strong> <?php echo e($user->email); ?></p>
                <p style="margin: 5px 0; font-size: 14px;"><strong>Password:</strong> <span style="background-color: rgba(0, 204, 102, 0.2); padding: 4px 8px; border-radius: 4px; font-family: monospace;"><?php echo e($password); ?></span></p>
            </div>
        ...
        <div style="text-align: center; margin-top: 30px;">
            <a href="<?php echo e(route('login')); ?>" style="display: inline-block; background-color: #00cc66; color: #000000; padding: 15px 40px; text-decoration: none; border-radius: 8px; font-weight: 700; font-size: 16px; text-transform: uppercase; letter-spacing: 1px;">
                Login Now
            </a>
        </div>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0; text-align: center; color: #666; font-size: 12px;">
            ...
            <p style="margin: 10px 0 0 0;">© <?php echo e(date('Y')); ?> HN Supplement. All rights reserved.</p>
        </div>
    </div>
</body>
</html>

<?php /**PATH D:\hnsupplement\resources\views/emails/trainer-approved.blade.php ENDPATH**/ ?>