                                            ...
                                            <td style="width: 140px;">
                                                <div class="booking-actions-group">
                                                    <?php if($booking->payment_status === 'paid'): ?>
                                                        ...
                                                        <button type="button" 
                                                                class="btn btn-sm btn-warning <?php echo e(!$isCompleted || $hasReview ? 'disabled' : ''); ?>" 
                                                                <?php if(!$isCompleted || $hasReview): ?> disabled <?php else: ?> data-bs-toggle="modal" data-bs-target="#feedbackModal<?php echo e($booking->id); ?>" <?php endif; ?>
                                                                title="<?php echo e($hasReview ? 'Feedback already submitted' : ($isCompleted ? 'Leave Feedback & Rating' : 'Complete all sessions to leave feedback')); ?>">
                                                        ...
                                                        <button type="button" 
                                                                class="btn btn-sm btn-danger <?php echo e(!$isUpcomingOrOngoing ? 'disabled' : ''); ?>" 
                                                                <?php if(!$isUpcomingOrOngoing): ?> disabled <?php else: ?> data-bs-toggle="modal" data-bs-target="#refundModal<?php echo e($booking->id); ?>" <?php endif; ?>
                                                                title="<?php echo e($isUpcomingOrOngoing ? 'Request Refund' : 'Refund only available for upcoming or ongoing bookings'); ?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?php echo e(route('customer.booking.reminder', $booking->id)); ?>" method="POST">
                                                        ...
                                                        <div class="modal-body" style="padding: 1rem;">
                                                            ...
                                                            <?php if($booking->reminders && $booking->reminders->count() > 0): ?>
                                                            <div class="mb-3" style="background: #f0f8ff; padding: 0.75rem; border-radius: 6px; border-left: 3px solid #17a2b8;">
                                                                ...
                                                                <ul style="margin: 0.5rem 0 0 0; padding-left: 1.5rem; font-size: 0.8rem;">
                                                                    <?php $__currentLoopData = $booking->reminders->sortBy('reminder_date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reminder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li style="margin-bottom: 0.5rem;">
                                                                        <strong><?php echo e(\Carbon\Carbon::parse($reminder->reminder_date)->format('M d, Y \a\t g:i A')); ?></strong>
                                                                        ...
                                                                        <?php endif; ?>
                                                                        <?php if($reminder->note): ?>
                                                                            <br><small style="color: #666;"><?php echo e($reminder->note); ?></small>
                                                                        <?php endif; ?>
                                                                    </li>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </ul>
