...
<?php $__env->startSection('title', 'Login - Book Your Trainer'); ?>
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <form class="auth-form" method="POST" action="<?php echo e(route('login.post')); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="role-selector">
                        <label class="role-option <?php echo e(old('role', 'customer') === 'customer' ? 'selected' : ''); ?>">
                            <input type="radio" name="role" value="customer" <?php echo e(old('role', 'customer') === 'customer' ? 'checked' : ''); ?> required>
                            <span class="radio-custom"></span>
                            <span class="role-text">Customer</span>
                        </label>
                        <label class="role-option <?php echo e(old('role') === 'trainer' ? 'selected' : ''); ?>">
                            <input type="radio" name="role" value="trainer" <?php echo e(old('role') === 'trainer' ? 'checked' : ''); ?> required>
                            <span class="radio-custom"></span>
            ...
            <div class="auth-footer">
                <p>Don't have an account? <a href="<?php echo e(route('signup')); ?>" class="auth-link">Sign up here</a></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hnsupplement\resources\views/auth/login.blade.php ENDPATH**/ ?>