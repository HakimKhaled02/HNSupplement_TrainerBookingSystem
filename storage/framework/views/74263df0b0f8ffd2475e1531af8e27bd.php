<?php $__env->startSection('title', 'Payment - Booking #' . $booking->id); ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="payment-card">
                    <div class="payment-header">
                        ...
                        <p class="payment-subtitle">Booking #<?php echo e($booking->id); ?></p>
                        <?php if($booking->payment_expires_at): ?>
                        ...
                        <div class="payment-booking-info">
                            ...
                            <div class="payment-info-row">
                                ...
                                <span class="payment-info-value">
                                    ...
                                    ?>
                                    <?php echo e(implode(', ', $selectedDays)); ?>
                    ...
                    <div class="payment-amount-section">
                        <div class="payment-amount-row">
                            ...
                            <span class="payment-amount-value">RM <?php echo e(number_format($booking->total_amount, 2)); ?></span>
                        </div>
                    </div>

                    <!-- Payment Form -->
                    <form action="<?php echo e(route('booking.payment.process', $booking->id)); ?>" method="POST" class="payment-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="bank-payment-fields" class="payment-fields" style="display: none;">
                            <div class="payment-bank-info">
                                ...
                                <p class="payment-bank-note">Please transfer the exact amount and include booking ID #<?php echo e($booking->id); ?> in the transfer reference.</p>
                            </div>
                        </div>

                        <div class="payment-actions">
                            <a href="<?php echo e(route('trainers')); ?>" class="payment-cancel-btn">
                                <i class="bi bi-arrow-left me-2"></i>Cancel
                            </a>
                            <button type="submit" class="payment-submit-btn">
                                <i class="bi bi-check-circle me-2"></i>Pay RM <?php echo e(number_format($booking->total_amount, 2)); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if($booking->payment_expires_at): ?>
        const expiresAt = new Date('<?php echo e($booking->payment_expires_at->toIso8601String()); ?>').getTime();
        ...
        function updateCountdown() {
            ...
            if (distance < 0) {
                ...
                setTimeout(function() {
                    window.location.href = '<?php echo e(route("trainers")); ?>';
                }, 2000);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hnsupplement\resources\views/bookings/payment.blade.php ENDPATH**/ ?>