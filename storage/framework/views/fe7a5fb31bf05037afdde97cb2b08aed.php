...
<?php $__env->startSection('title', 'Trainer Registration - Book Your Trainer'); ?>
...
<div class="auth-container">
    <div class="auth-wrapper-wide">
        <div class="auth-card-wide">
            ...
            <form class="auth-form" method="POST" action="<?php echo e(route('trainer.signup.post')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-input" required>
                            ...
                            <option value="strength" <?php echo e(old('category') === 'strength' ? 'selected' : ''); ?>>Strength Training</option>
                            <option value="cardio" <?php echo e(old('category') === 'cardio' ? 'selected' : ''); ?>>Cardio & Fitness</option>
                            <option value="yoga" <?php echo e(old('category') === 'yoga' ? 'selected' : ''); ?>>Yoga & Wellness</option>
                            <option value="pilates" <?php echo e(old('category') === 'pilates' ? 'selected' : ''); ?>>Pilates</option>
                            <option value="boxing" <?php echo e(old('category') === 'boxing' ? 'selected' : ''); ?>>Boxing & MMA</option>
                            <option value="nutrition" <?php echo e(old('category') === 'nutrition' ? 'selected' : ''); ?>>Nutrition</option>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="state" name="state" class="form-input" required>
                            ...
                            <option value="selangor" <?php echo e(old('state') === 'selangor' ? 'selected' : ''); ?>>Selangor</option>
                            <option value="kuala_lumpur" <?php echo e(old('state') === 'kuala_lumpur' ? 'selected' : ''); ?>>Kuala Lumpur</option>
                            ...
                            <option value="negeri_sembilan" <?php echo e(old('state') === 'negeri_sembilan' ? 'selected' : ''); ?>>Negeri Sembilan</option>
                            ...
                            <option value="labuan" <?php echo e(old('state') === 'labuan' ? 'selected' : ''); ?>>Labuan</option>
            ...
            <div class="auth-footer">
                ...
                <p style="margin-top: 10px;">Looking to book a trainer? <a href="<?php echo e(route('signup')); ?>" class="auth-link">Sign up as Customer</a></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hnsupplement\resources\views/auth/trainer-signup.blade.php ENDPATH**/ ?>