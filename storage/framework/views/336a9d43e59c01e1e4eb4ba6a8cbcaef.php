...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: rgba(26, 26, 26, 0.95) !important; backdrop-filter: blur(10px); border-bottom: 1px solid rgba(0, 204, 102, 0.3); padding: 1rem 0; z-index: 1050;">
        <div class="container-fluid px-4">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('trainer.dashboard')); ?>">
            ...
            <div id="dashboard-section" class="content-section active">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-card-value"><?php echo e($trainer->rating ?? '0.00'); ?></div>
                    </div>
            ...
            <div id="profile-section" class="content-section">
                ...
                <div class="content-card">
                    ...
                    <div style="color: #cccccc; font-family: 'Poppins', sans-serif;">
                        <p><strong style="color: var(--accent-green);">Name:</strong> <?php echo e(auth()->user()->name); ?></p>
                        <p><strong style="color: var(--accent-green);">Email:</strong> <?php echo e(auth()->user()->email); ?></p>
                        <?php if($trainer): ?>
                            <p><strong style="color: var(--accent-green);">Phone:</strong> <?php echo e($trainer->phone ?? 'N/A'); ?></p>
                            <p><strong style="color: var(--accent-green);">State:</strong> <?php echo e($trainer->state ?? 'N/A'); ?></p>
                            <p><strong style="color: var(--accent-green);">Area:</strong> <?php echo e($trainer->area ?? 'N/A'); ?></p>
                            <p><strong style="color: var(--accent-green);">Category:</strong> <?php echo e($trainer->category ?? 'N/A'); ?></p>
                            <p><strong style="color: var(--accent-green);">Status:</strong> 
                                <span style="background: rgba(0, 204, 102, 0.2); color: var(--accent-green); padding: 5px 12px; border-radius: 12px; font-size: 0.85rem; font-weight: 600;">
                                    <?php echo e(ucfirst($trainer->status ?? 'pending')); ?>
...
<?php /**PATH D:\hnsupplement\resources\views/trainer/dashboard.blade.php ENDPATH**/ ?>