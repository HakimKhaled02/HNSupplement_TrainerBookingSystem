...
@section('title', 'Payment Successful - Booking #' . $booking->id)
                ...
                <div class="payment-success-card">
                    ...
                    <div class="payment-success-details">
                        <div class="payment-success-detail-item">
                            ...
                            <span class="payment-success-detail-value">#{{ $booking->id }}</span>
                        </div>
                        <div class="payment-success-detail-item">
                            <span class="payment-success-detail-label">Trainer:</span>
                            <span class="payment-success-detail-value">{{ $booking->trainer->user->name }}</span>
                        </div>
                        <div class="payment-success-detail-item">
                            <span class="payment-success-detail-label">Amount Paid:</span>
                            <span class="payment-success-detail-value">RM {{ number_format($booking->total_amount, 2) }}</span>
                        </div>
                        <div class="payment-success-detail-item">
                    ...
                    <div class="payment-success-actions">
                        <a href="{{ route('home') }}" class="payment-success-btn payment-success-btn-primary">
                            <i class="bi bi-house me-2"></i>Go to Home
                        </a>
                        <a href="{{ route('trainers') }}" class="payment-success-btn payment-success-btn-secondary">
